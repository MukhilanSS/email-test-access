...
API_URL = "https://mukhilanss.github.io/email-test-access/emails.json"  # Replace with your actual API URL
...
def create_payload_with_new_emails(original_data_raw, new_emails):
    ...
    # Create a new list of data, excluding any keys that start with 'library[readers]'
    # This effectively removes all the old email entries.
    filtered_data = [
        (k, v) for k, v in parsed_data if not k.startswith('library[readers]')
    ]

    # Now, add the new emails to the list of data.
    # We will replicate the structure 'library[readers][INDEX][KEY]'
    for i, email in enumerate(new_emails):
        # Add the email entry
        filtered_data.append((f'library[readers][{i}][email]', email))
        # Add the 'type', assuming 'google' as per the original request
        filtered_data.append((f'library[readers][{i}][type]', 'google'))
        # Add the 'password' field, which is empty in the original request
        filtered_data.append((f'library[readers][{i}][password]', ''))
        # Add content field (set to 1 for access)
        filtered_data.append((f'library[readers][{i}][content]', '1'))
...
def update_heyzine_library(url, headers, data_raw, emails):
    """
    Updates a Heyzine library with new reader emails.
    
    Args:
        url (str): The Heyzine library save endpoint URL
        headers (dict): HTTP headers including cookies and authentication
        data_raw (str): The raw form data from the library configuration
...
def main():
    ...
    heyzine_headers = {
        ...
        'newrelic': 'eyJ2IjpbMCwxXSwiZCI6eyJ0eSI6IkJyb3dzZXIiLCJhYyI6IjMyMzU3NzkiLCJhcCI6IjUzODYxMDU0NCIsImlkIjoiNzdmMjVjNzhkM2I3MjEzOSIsInRyIjoiN2VlMjc3NmFiOTQ4MTk3NzNlZWExYmQ5ZTllM2MzNDQiLCJ0aSI6MTc2Mjg4Mjc0MDU4N319',
        'sec-ch-ua': '"Not:A-Brand";v="24", "Chromium";v="134"',
        'sec-ch-ua-mobile': '?0',
        'sec-ch-ua-platform': '"Windows"',
        'traceparent': '00-7ee2776ab94819773eea1bd9e9e3c344-77f25c78d3b72139-01',
        'tracestate': '3235779@nr=0-1-3235779-538610544-77f25c78d3b72139----1762882740587',
    }
    
    # Library data - UPDATED WITH NEW LIBRARY DATA FROM CURL
    heyzine_data_raw = 'library%5Bid_library%5D=76986&library%5Bname%5D=0f819e940b99ddff4e3360a280decc3c553d65a5&library%5Bid_user%5D=2261619&library%5Bvol%5D=&library%5Bver%5D=17&library%5Bcustom_name%5D=notes.html&library%5Bpublished%5D=1&library%5Btitle%5D=DSA+Book-Shelf&library%5Bsubtitle%5D=&library%5Bdescription%5D=&library%5Bprivate_notes%5D=&library%5Bthumbnail%5D=0f819e940b99ddff4e3360a280decc3c553d65a5-18-thumb.jpg&library%5Bfavicon%5D=&library%5Blayout%5D=book&library%5Bbackground%5D=https%3A%2F%2Fcdnc.heyzine.com%2Ffiles%2Fbackgrounds%2Fback14.svg&library%5Bbackground_color%5D=&library%5Bbackground_style%5D%5Bblur%5D=0&library%5Bbackground_style%5D%5Btransparency%5D=40&library%5Bbackground_style%5D%5Bsize%5D=Cover&library%5Bbackground_style%5D%5Bposition%5D=center+center&library%5Bheader_style%5D%5Bback_color%5D=rgba(255%2C+255%2C+255%2C+1)&library%5Bheader_style%5D%5Bfont%5D=Arial&library%5Bheader_style%5D%5Bfont_color%5D=rgba(86%2C+41%2C+176%2C+1)&library%5Bheader_style%5D%5Bstyle%5D=transparent&library%5Bcompany_logo%5D=&library%5Bcompany_logo_link%5D=&library%5Bcompany_logo_link_mode%5D=&library%5Bcontrols_iconset%5D=iconset3_6&library%5Bcontrols_pos%5D=0&library%5Bshow_share%5D=0&library%5Bshow_fullscreen%5D=1&library%5Bshow_search%5D=1&library%5Bshow_shelf%5D=1&library%5Bshelf_color%5D=rgba(230%2C+46%2C+43%2C+0.67)&library%5Bflips_rounded%5D=1&library%5Bflips_details%5D=0&library%5Bflips_open%5D=2&library%5Bpassword_enabled%5D=2&library%5Bpassword_name%5D=&library%5Bpassword%5D=&library%5Bpassword_text%5D=&library%5Bpassword_text_email%5D=Authentication&library%5Ballowed_enabled%5D=0&library%5Ballowed_direct%5D=1&library%5Ballowed_domains%5D=&library%5Ballowed_meta_index%5D=1&library%5Bsocial_title%5D=&library%5Bsocial_description%5D=&library%5Bsocial_thumbnail%5D=&library%5Baccess_count%5D=101&library%5Bcreate_date%5D=2025-11-06+21%3A09%3A42&library%5Bedit_access_date%5D=2025-11-11+17%3A10%3A19&library%5Blast_access_date%5D=2025-11-11+17%3A32%3A15&library%5Bdelete_date%5D=&library%5Bremove_date%5D=&library%5Bthumbnail_url%5D=https%3A%2F%2Fcdnc.heyzine.com%2Ffiles%2Flibraries%2F0f819e940b99ddff4e3360a280decc3c553d65a5-17-thumb.jpg&library%5Babsolute_url%5D=%2Fshelf%2F0f819e940b.html&library%5Bflipbooks%5D%5B0%5D%5Bname%5D=6b05841d5564f52a39dfc1da97beb27f77542883.pdf&library%5Bflipbooks%5D%5B0%5D%5Bposition%5D=1&library%5Bflipbooks%5D%5B0%5D%5Bupload_date%5D=2025-09-20+07%3A48%3A36&library%5Bflipbooks%5D%5B0%5D%5Bthumbnail_url%5D=%2Ffiles%2Fuploaded%2F6b05841d5564f52a39dfc1da97beb27f77542883.pdf-thumb.jpg&library%5Bflipbooks%5D%5B0%5D%5Btitle%5D=Master+DSA+Concepts&library%5Bflipbooks%5D%5B0%5D%5Bsubtitle%5D=&library%5Bflipbooks%5D%5B0%5D%5Bdescription%5D=Master-level+DSA+theory&library%5Bflipbooks%5D%5B0%5D%5Burl%5D=https%3A%2F%2Fjb.hflip.co%2F6b05841d55.html&library%5Bflipbooks%5D%5B0%5D%5Btext%5D=6b05841d5564f52a39dfc1da97beb27f77542883.pdf.txt&library%5Bflipbooks%5D%5B1%5D%5Bname%5D=4668337bb23b75487391fe3e3bc26166fbf9d241.pdf&library%5Bflipbooks%5D%5B1%5D%5Bposition%5D=1014&library%5Bflipbooks%5D%5B1%5D%5Bupload_date%5D=2025-08-31+10%3A27%3A03&library%5Bflipbooks%5D%5B1%5D%5Bthumbnail_url%5D=%2Ffiles%2Fuploaded%2F4668337bb23b75487391fe3e3bc26166fbf9d241-7.pdf-thumb.jpg&library%5Bflipbooks%5D%5B1%5D%5Btitle%5D=Patterns+%26+Sub+Patterns+Notes&library%5Bflipbooks%5D%5B1%5D%5Bsubtitle%5D=&library%5Bflipbooks%5D%5B1%5D%5Bdesc